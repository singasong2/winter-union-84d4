...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/winter-union-84d4
```

A live public deployment of this template is available at [https://winter-union-84d4.templates.workers.dev](https://winter-union-84d4.templates.workers.dev)
